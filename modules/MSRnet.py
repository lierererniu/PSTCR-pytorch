...
class TSRnet(nn.Module):
    def __init__(self, num_res=1, ResBlock=ResBlock):
        ...
        self.SAM1 = SAM(base_channel)
        self.SAM2 = SAM(base_channel)
    ...
    def forward(self, cloud):
        ...
        sam, output1 = self.SAM1(res4, cloud[0])  # 32

        outputs.append(output1)

        # stage2
        z = self.feat_extract[5](cloud[1])
        ...
        z = self.Convs[6](z)  # 64 - 32  1
        z = self.Decoder[5](z)  # 32
        sam1, output2 = self.SAM2(z, cloud[1])  # 32
...
if __name__ == '__main__':
    ...
    image2 = torch.randn((1, 1, 512, 512))
    image = [image1, image2]
